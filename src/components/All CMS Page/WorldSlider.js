...
import useHighlightsNews from "../../hooks/useWorld"; // Custom hook
    ...
    <section className="wpo-blog-highlights-section mt-5">
      <div className="container">
        <div className="wpo-section-title">
          <h2>உலகின் முக்கிய நிகழ்வுகள்</h2>
        </div>
...
/* ✅ Card Component */
const WorldCard = ({ highlight, ClickHandler }) => {
  return (
    <div className="p-2 h-100">
      <div className="wpo-blog-item shadow rounded-lg overflow-hidden d-flex flex-column h-100">
        ...
        <div className="wpo-blog-content p-3 d-flex flex-column flex-grow-1">
          <h2 className="h5">
            <Link onClick={ClickHandler} to={`/world/${highlight.slug}`}>
              {highlight.title}
            </Link>
          </h2>
