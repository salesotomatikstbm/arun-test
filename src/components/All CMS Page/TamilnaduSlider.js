...
import useHighlightsNews from "../../hooks/useTamilnadu"; // Custom hook

import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";

const TamilnaduSlider = () => {
    ...
    <section className="wpo-blog-highlights-section mt-5">
      <div className="container">
        <div className="wpo-section-title">
          <h2>தமிழ்நாட்டின் முக்கிய நிகழ்வுகள்</h2>
        </div>

        {/* ✅ Slider instead of grid/sidebar */}
        <Slider {...settings}>
...
/* ✅ Card Component */
const TamilnaduCard = ({ highlight, ClickHandler }) => {
  return (
    <div className="p-2 h-100">
      <div className="wpo-blog-item shadow rounded-lg overflow-hidden d-flex flex-column h-100">
        ...
        <div className="wpo-blog-content p-3 d-flex flex-column flex-grow-1">
          <h2 className="h5">
            <Link onClick={ClickHandler} to={`/tamilnadu/${highlight.slug}`}>
              {highlight.title}
            </Link>
          </h2>
          ...
          <p
            ...
            style={{
              ...
              overflow: "hidden",
              minHeight: "3em", // equal space for 2 lines
            }}
          >
...
export default TamilnaduSlider;
