...
import useHighlightsNews from "../../hooks/useHistory"; // Custom hook
    ...
    <section className="wpo-blog-highlights-section mt-5">
      <div className="container">
        <div className="wpo-section-title">
          <h2>முக்கிய வரலாற்று நிகழ்வுகள்</h2>
        </div>

        {/* ✅ Slider Replacing Sidebar & Grid */}
        <Slider {...settings}>
    ...
    <div className="p-2 h-100">
      <div className="wpo-blog-item shadow rounded-lg overflow-hidden d-flex flex-column h-100">
        ...
        <div className="wpo-blog-content p-3 d-flex flex-column flex-grow-1">
          <h2 className="h5">
            <Link onClick={ClickHandler} to={`/history/${highlight.slug}`}>
              {highlight.title}
            </Link>
          </h2>
          ...
          <p
            ...
            style={{
              ...
              overflow: "hidden",
              minHeight: "3em", // keeps equal height for 2 lines
            }}
          >
